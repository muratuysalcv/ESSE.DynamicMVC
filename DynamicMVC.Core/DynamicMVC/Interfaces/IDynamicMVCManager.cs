...
namespace DynamicMVC.Core.DynamicMVC.Interfaces
{
    public interface IDynamicMvcManager
    {
        ...
        /// <returns></returns>
        DynamicEntityMetadataLibrary.Core.Models.DynamicEntityMetadata GetDynamicEntityMetadata(string typeName);
        ...
        void LoadCreateIncludes(DynamicEntityMetadataLibrary.Core.Models.DynamicEntityMetadata dynamicEntityMetadata, dynamic item, IDynamicRepository dynamicRepository, params string[] includes);
